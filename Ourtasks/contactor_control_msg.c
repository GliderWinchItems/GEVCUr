...
//                                         "12345678901234567890"
		lcdi2cputs(&punitd4x20,CNCTRLCDB,0,"CNTKR   ER dlc != 3 ");
...
//	lcdprintf(&gevcufunction.pbuflcd1,CNCTRLCDA,0," : %2i %2i ",(p->cd.uc[0] & 0xf),(p->cd.uc[2] & 0xf));
 ...
 {	// Here, no critical faults
	...
	case	DISCONNECTED:   /*  0 */
//                                                   12345678901234567890              
		lcdi2cputs         (&punitd4x20,CNCTRLCDA,0,"CNTKR  DISCONNECTED "); 
		break;
	case	CONNECTING:     /*  1 */
//                                                   12345678901234567890              
		lcdi2cputs         (&punitd4x20,CNCTRLCDA,0,"CNTKR  CONNECTING   ");
		break;	
	case	CONNECTED:      /*  2 */
//                                                   12345678901234567890              
		lcdi2cputs         (&punitd4x20,CNCTRLCDA,0,"CNTKR  CONNECTED    ");
		break;	
	case	FAULTING:       /*  3 */
//                                                   12345678901234567890              
		lcdi2cputs         (&punitd4x20,CNCTRLCDA,0,"CNTKR  FAULTING     ");
		break;	
	case	FAULTED:        /*  4 */
//                                                   12345678901234567890              
		lcdi2cputs         (&punitd4x20,CNCTRLCDA,0,"CNTKR  FAULTED      ");
		break;	
	case	RESETTING:      /*  5 */
//                                                   12345678901234567890              
		lcdi2cputs         (&punitd4x20,CNCTRLCDA,0,"CNTKR  RESETTING    ");
		break;	
	case	DISCONNECTING:  /*  6 */
//                                                   12345678901234567890              
		lcdi2cputs         (&punitd4x20,CNCTRLCDA,0,"CNTKR  DISCONNECTING");
		break;	
	case	OTOSETTLING:    /*  7 */
//                                                   12345678901234567890              
		lcdi2cputs         (&punitd4x20,CNCTRLCDA,0,"CNTKR  OTOSETTLNG   "); 
		break;
	default:
//                                                   12345678901234567890              
		lcdi2cputs         (&punitd4x20,CNCTRLCDA,0,"CNTKR  RCV BAD CODE ");
	}
 }
 else
 { // Here, fault code
