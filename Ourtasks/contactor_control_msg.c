...
//                                                   12345678901234567890             
		...
		lcdi2cputs         (&punitd4x20,CNCTRLCDB,0,"CONTCTR ER dlc != 3");
		return;
	}
