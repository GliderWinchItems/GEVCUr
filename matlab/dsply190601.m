...
M = csvread('logfile190601.csv', 1, 0);    %   read file skipping first line
...
plot(t, [M(:, 17)/10, (M(:, 2:2)- mean(M(640:800, 2:2))) * 30,...
    (M(:, 3)- mean(M(640:800, 3)))* 3  M(:, 22:24)/10], 'linewidth', 1.5)   %   temp plot
ylim([-10 50])
title('Torques')
ylabel('Torque (Nm)')
